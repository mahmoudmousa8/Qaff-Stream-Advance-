...
const translations = {
    en: {
        ...
        lblRepeat30m: '30-Min Repeat',
        lblRepeat1h: '1-Hour Repeat',
        lblRepeat2h: '2-Hour Repeat',
        colActions: 'Actions',
        colStatus: 'Status',
        colReset: 'Reset',
        colLogs: 'Logs',
    ...
    ar: {
        ...
        lblWeekly: 'إسبوعياً',
        lblHourly: '20 دقيقة',
        lblRepeat30m: 'تكرار 30',
        lblRepeat1h: 'تكرار ساعة',
        lblRepeat2h: 'تكرار ساعتين',
        ...
        confirmHourlyAll: 'هل تريد تفعيل/إلغاء التكرار كل 20 دقيقة لجميع القنوات؟',
